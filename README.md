...
- [IDEs and Code Editors](#ides-and-code-editors)
  - [Full-featured IDEs](#full-featured-ides)
  - [Code Editors with AI Features](#code-editors-with-ai-features)
...
- [Mutable](https://mutable.ai/) - AI-powered platform for enhancing software engineer productivity and efficiency.
...
- [MarsCode](https://www.marscode.com/) - AI-powered IDE for enhanced coding efficiency with support for over 100 programming languages.
- [PyCharm](https://www.jetbrains.com/pycharm/) - Popular IDE for Python programming with intelligent code assistance and extensive plugin ecosystem.
...
- [Zed](https://zed.dev/) - Next-generation code editor designed for high-performance collaboration with AI integration.
- [Void](https://voideditor.com/) - Open-source AI-powered code editor built on Visual Studio Code with local model hosting support.
...
- [Continue](https://www.continue.dev/) - AI-powered code assistant for enhanced productivity with customization features.
- [Cody](https://sourcegraph.com/cody) - AI-powered coding assistant by Sourcegraph used by over 2.5 million engineers.
- [Tabnine](https://www.tabnine.com/) - AI-powered code assistant with privacy focus and wide language support.
...
- [Plandex](https://plandex.ai/) - Open-source, terminal-based AI coding engine for complex, multi-file projects.
- [Aider](https://aider.chat/) - Open-source AI pair programming tool with Git integration and voice coding support.
- [OpenHands](https://github.com/All-Hands-AI/OpenHands) - Open-source AI-powered software development assistant with multi-language support and CI/CD integration.
- [Claude-dev](https://github.com/saoudrizwan/claude-dev) - Open-source autonomous coding agent for IDEs with error monitoring and proactive fixing.
...
- [Codium.ai](https://www.codium.ai/) - Automated unit test generation and AI-driven code assistance tool.
- [Codiga](https://www.codiga.io/) - Customizable static code analysis tool with real-time feedback and automated code reviews.
- [CodeRabbit](https://coderabbit.ai/) - AI-powered code review platform for streamlining software development.
- [Snyk](https://snyk.io/) - Developer-first security platform for building and maintaining secure applications.
- [Mutahunter](https://mutahunter.ai) - Open-source, AI-driven software testing tool leveraging Large Language Models (LLMs).

## Extensions and Plugins

- [Pieces](https://pieces.app/) - AI-powered coding assistant and productivity tool with intelligent snippet storage.
...
- [Stenography.dev](https://stenography.dev/) - Innovative tool for simplifying and enhancing code documentation using AI.
- [Mintlify](https://mintlify.com/) - Modern documentation platform for creating beautiful, user-friendly documentation with AI assistance.
- [AI Kernel Explorer](https://github.com/mathiscode/ai-kernel-explorer) - Open-source tool for navigating and understanding Linux kernel source code using AI-generated summaries.
...
- [AI2SQL](https://www.ai2sql.io/) - AI-powered SQL query builder for simplified query creation and optimization.
...
- [WhoDB](https://github.com/clidey/whodb) - SQL/NoSQL/Graph/Cache/Object data explorer with AI-powered chat and other useful features.
